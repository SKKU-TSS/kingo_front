...
import {
  approvePendingData,
  getPendingData,
} from "../../remote/PendingTransaction";
import {
  actionDashboardItem,
  DASHBOARD_ITEM,
} from "../../redux/dashboardTable/dashbaordTable";
  ...
  return (
    <VStack style={style} p={8} align="flex-start" m={3}>
      <VStack spacing={0} p={2}>
        <Text fontSize="24px">{TEXT_POINT_INFO}</Text>
        <Box
...
const NullReport = () => {
  return (
    <Flex width="full" height="full" align="center" justify="space-evenly">
      <Text fontSize="xl">대기중인 내역이 없습니다.</Text>
    </Flex>
  );
};
